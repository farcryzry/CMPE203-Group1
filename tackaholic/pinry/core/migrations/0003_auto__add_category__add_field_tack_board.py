...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tack.board'
        db.add_column(u'core_tack', 'board',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Board'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tack.board'
        db.delete_column(u'core_tack', 'board_id')
    ...
    models = {
        ...
        u'core.tack': {
            ...
            'board': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Board']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
